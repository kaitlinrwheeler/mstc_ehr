...
document.addEventListener('DOMContentLoaded', function () {
    ...
    checkboxes.forEach(checkbox => {
        checkbox.addEventListener('change', function (event) {
            ...
            const allergyId = this.getAttribute('data-allergyId'); // Only the one that was selected
            ...
            fetch(`/Allergy/UpdateAllergyActiveStatus?allergyId=${allergyId}&activeStatus=${isActive}`, {
                method: 'POST',
                headers: {
